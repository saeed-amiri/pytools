...
1) all the citations from one source should be used with the same label in the latex file.
...
3) how to cite in the text:
    - for a normal journal, use the "doi"  of the source ex.: \cite{10.1016/0039-6028(93)91022-h}
    - for arxiv papres use the arxiv's label ex.: \cite{arxiv:2011.01070v1}
    - for the book, use the ISBN of the book ex.: \cite{isbn:9780521392938} !! always check the bib for the book, especially the "authors."
...
One module should be installed for the books' bib: "isbnlib" [https://pypi.org/project/isbnlib/]
    use pip:
        pip install isbnlib
# updates:
